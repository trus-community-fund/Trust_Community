...
function Home() {
            ...
            const run = {
                "Home.useEffect.run": async ()=>{
                    ...
                    auth.onAuthStateChanged({
                        "Home.useEffect.run": (u)=>{
                            if (!u) {
                                router.push('/login');
                            } else {
                                setUser(u);
                                // 2. Fetch Data from Firebase (Realtime)
                                const dbRef = db.ref();
                                dbRef.on('value', {
                                    "Home.useEffect.run": (snapshot)=>{
                                        const rawData = snapshot.val();
                                        const processed = processRawData(rawData); // Logic lagaya
                                        setData(processed);
                                        setLoading(false);
                                    }
                                }["Home.useEffect.run"]);
    ...
    if (loading) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "p-10 text-center text-blue-900 font-bold",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: data.processedMembers.map((member)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                style: {
                                    background: 'white',
                                    padding: '10px',
                                    borderRadius: '10px',
...
_s(Home, "pCfFwSOqf/Ev8A08k+y10wRw5CU=", false, function() {
    return [
